...
export namespace akun {
  export class ServiceClient {
     ...
     */
    public async create(
      params: RequestType<typeof api_akun_create_create>
    ): Promise<ResponseType<typeof api_akun_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/akun`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_akun_create_create
      >;
    }
    ...
    public async deleteAkun(params: { id: string }): Promise<void> {
      await this.baseClient.callTypedAPI(
        `/akun/${encodeURIComponent(params.id)}`,
    ...
    public async get(params: {
      id: string;
    }): Promise<ResponseType<typeof api_akun_get_get>> {
      // Now make the actual call to the API
     ...
     */
    public async list(
      params: RequestType<typeof api_akun_list_list>
    ): Promise<ResponseType<typeof api_akun_list_list>> {
     ...
     */
    public async update(
      params: RequestType<typeof api_akun_update_update>
    ): Promise<ResponseType<typeof api_akun_update_update>> {
...
export namespace auth {
  export class ServiceClient {
    ...
    public async getProfile(
      params: RequestType<typeof api_auth_get_profile_getProfile>
    ): Promise<ResponseType<typeof api_auth_get_profile_getProfile>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/auth/profile`, {
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_auth_get_profile_getProfile
      >;
    }
    ...
    public async login(
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/auth/login`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
     ...
     */
    public async logout(
      params: RequestType<typeof api_auth_logout_logout>
    ): Promise<void> {
      await this.baseClient.callTypedAPI(`/auth/logout`, {
        method: "POST",
        body: JSON.stringify(params),
      });
    }
    ...
    public async refreshToken(
      params: RequestType<typeof api_auth_refresh_refreshToken>
    ): Promise<ResponseType<typeof api_auth_refresh_refreshToken>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/auth/refresh`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_auth_refresh_refreshToken
      >;
    }
    ...
    public async register(
      params: RequestType<typeof api_auth_register_register>
    ): Promise<ResponseType<typeof api_auth_register_register>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/auth/register`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_auth_register_register
      >;
    }
    ...
    public async updateProfile(
      params: RequestType<typeof api_auth_update_profile_updateProfile>
    ): Promise<ResponseType<typeof api_auth_update_profile_updateProfile>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/auth/profile`, {
        method: "PUT",
        body: JSON.stringify(params),
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_auth_update_profile_updateProfile
      >;
    }
  }
}
...
import {
  hitungKPR as api_kalkulator_kpr_hitungKPR,
  saveCalculation as api_kalkulator_kpr_saveCalculation,
  getSavedCalculations as api_kalkulator_kpr_getSavedCalculations,
  getSavedCalculation as api_kalkulator_kpr_getSavedCalculation,
  updateCalculation as api_kalkulator_kpr_updateCalculation,
  deleteCalculation as api_kalkulator_kpr_deleteCalculation,
} from "~backend/kalkulator/kpr";
...
export namespace kalkulator {
  export class ServiceClient {
     ...
     */
    public async hitungCustomGoal(
      params: RequestType<typeof api_kalkulator_custom_goal_hitungCustomGoal>
    ): Promise<
      ResponseType<typeof api_kalkulator_custom_goal_hitungCustomGoal>
    > {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/kalkulator/custom-goal`,
        { method: "POST", body: JSON.stringify(params) }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_custom_goal_hitungCustomGoal
      >;
    }
     ...
     */
    public async hitungDanaDarurat(
      params: RequestType<typeof api_kalkulator_dana_darurat_hitungDanaDarurat>
    ): Promise<
      ResponseType<typeof api_kalkulator_dana_darurat_hitungDanaDarurat>
    > {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_dana_darurat_hitungDanaDarurat
      >;
    }
     ...
     */
    public async hitungKPR(
      params: RequestType<typeof api_kalkulator_kpr_hitungKPR>
    ): Promise<ResponseType<typeof api_kalkulator_kpr_hitungKPR>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/kalkulator/kpr`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_kpr_hitungKPR
      >;
    }
     ...
     */
    public async hitungPensiun(
      params: RequestType<typeof api_kalkulator_pensiun_hitungPensiun>
    ): Promise<ResponseType<typeof api_kalkulator_pensiun_hitungPensiun>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/kalkulator/pensiun`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_pensiun_hitungPensiun
      >;
    }
    ...
    public async saveCalculation(
      params: RequestType<typeof api_kalkulator_kpr_saveCalculation>
    ): Promise<ResponseType<typeof api_kalkulator_kpr_saveCalculation>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/kalkulator/save`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_kpr_saveCalculation
      >;
    }
     ...
     */
    public async getSavedCalculations(
      params: RequestType<typeof api_kalkulator_kpr_getSavedCalculations>
    ): Promise<ResponseType<typeof api_kalkulator_kpr_getSavedCalculations>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        tenant_id: params.tenant_id,
        type: params.type,
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/kalkulator/saved`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_kpr_getSavedCalculations
      >;
    }
     ...
     */
    public async getSavedCalculation(params: {
      id: string;
      tenant_id: string;
    }): Promise<ResponseType<typeof api_kalkulator_kpr_getSavedCalculation>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        tenant_id: params.tenant_id,
      });
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/kalkulator/saved/${encodeURIComponent(params.id)}`,
        { query, method: "GET", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_kpr_getSavedCalculation
      >;
    }
    ...
    public async updateCalculation(
      params: RequestType<typeof api_kalkulator_kpr_updateCalculation>
    ): Promise<ResponseType<typeof api_kalkulator_kpr_updateCalculation>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
        tenant_id: params.tenant_id,
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_kpr_updateCalculation
      >;
    }
     ...
     */
    public async deleteCalculation(params: {
      id: string;
      tenant_id: string;
    }): Promise<ResponseType<typeof api_kalkulator_kpr_deleteCalculation>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        tenant_id: params.tenant_id,
      });
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kalkulator_kpr_deleteCalculation
      >;
    }
  }
}
...
export namespace kategori {
  export class ServiceClient {
     ...
     */
    public async create(
      params: RequestType<typeof api_kategori_create_create>
    ): Promise<ResponseType<typeof api_kategori_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/kategori`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kategori_create_create
      >;
    }
    ...
    public async deleteKategori(params: { id: string }): Promise<void> {
      await this.baseClient.callTypedAPI(
        `/kategori/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
    }
    ...
    public async get(params: {
      id: string;
    }): Promise<ResponseType<typeof api_kategori_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/kategori/${encodeURIComponent(params.id)}`,
        { method: "GET", body: undefined }
     ...
     */
    public async list(
      params: RequestType<typeof api_kategori_list_list>
    ): Promise<ResponseType<typeof api_kategori_list_list>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        include_system:
          params["include_system"] === undefined
            ? undefined
            : String(params["include_system"]),
        limit: params.limit === undefined ? undefined : String(params.limit),
        offset: params.offset === undefined ? undefined : String(params.offset),
        parent_only:
          params["parent_only"] === undefined
            ? undefined
            : String(params["parent_only"]),
        tenant_id: params["tenant_id"],
      });
     ...
     */
    public async update(
      params: RequestType<typeof api_kategori_update_update>
    ): Promise<ResponseType<typeof api_kategori_update_update>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
        ikon: params.ikon,
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_kategori_update_update
      >;
    }
  }
}
...
export namespace laporan {
  export class ServiceClient {
     ...
     */
    public async laporanBudgetVsActual(
      params: RequestType<
        typeof api_laporan_budget_vs_actual_laporanBudgetVsActual
      >
    ): Promise<
      ResponseType<typeof api_laporan_budget_vs_actual_laporanBudgetVsActual>
    > {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
     ...
     */
    public async laporanCashflow(
      params: RequestType<typeof api_laporan_cashflow_laporanCashflow>
    ): Promise<ResponseType<typeof api_laporan_cashflow_laporanCashflow>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/laporan/cashflow`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_laporan_cashflow_laporanCashflow
      >;
    }
     ...
     */
    public async laporanNetWorth(
      params: RequestType<typeof api_laporan_net_worth_laporanNetWorth>
    ): Promise<ResponseType<typeof api_laporan_net_worth_laporanNetWorth>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        tanggal_dari: params["tanggal_dari"],
        tanggal_sampai: params["tanggal_sampai"],
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/laporan/net-worth`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_laporan_net_worth_laporanNetWorth
      >;
    }
  }
}
...
export namespace tenant {
  export class ServiceClient {
     ...
     */
    public async create(
      params: RequestType<typeof api_tenant_create_create>
    ): Promise<ResponseType<typeof api_tenant_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/tenant`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_tenant_create_create
      >;
    }
    ...
    public async deleteTenant(params: { id: string }): Promise<void> {
      await this.baseClient.callTypedAPI(
        `/tenant/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
    }
    ...
    public async get(params: {
      id: string;
    }): Promise<ResponseType<typeof api_tenant_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/tenant/${encodeURIComponent(params.id)}`,
        { method: "GET", body: undefined }
     ...
     */
    public async list(
      params: RequestType<typeof api_tenant_list_list>
    ): Promise<ResponseType<typeof api_tenant_list_list>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        limit: params.limit === undefined ? undefined : String(params.limit),
        offset: params.offset === undefined ? undefined : String(params.offset),
     ...
     */
    public async update(
      params: RequestType<typeof api_tenant_update_update>
    ): Promise<ResponseType<typeof api_tenant_update_update>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_tenant_update_update
      >;
    }
  }
}
...
export namespace transaksi {
  export class ServiceClient {
     ...
     */
    public async create(
      params: RequestType<typeof api_transaksi_create_create>
    ): Promise<ResponseType<typeof api_transaksi_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/transaksi`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_transaksi_create_create
      >;
    }
    ...
    public async createTransfer(
      params: RequestType<typeof api_transaksi_transfer_createTransfer>
    ): Promise<ResponseType<typeof api_transaksi_transfer_createTransfer>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/transaksi/transfer`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_transaksi_transfer_createTransfer
      >;
    }
    ...
    public async deleteTransaksi(params: { id: string }): Promise<void> {
      await this.baseClient.callTypedAPI(
        `/transaksi/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
    }
    ...
    public async get(params: {
      id: string;
    }): Promise<ResponseType<typeof api_transaksi_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/transaksi/${encodeURIComponent(params.id)}`,
        { method: "GET", body: undefined }
     ...
     */
    public async list(
      params: RequestType<typeof api_transaksi_list_list>
    ): Promise<ResponseType<typeof api_transaksi_list_list>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        akun_id: params["akun_id"],
        jenis: params.jenis,
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_transaksi_list_list
      >;
    }
     ...
     */
    public async getAccountHistory(params: {
      tenant_id: string;
      akun_id: string;
      limit?: number;
      offset?: number;
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/history/${encodeURIComponent(params.akun_id)}`,
        { query, method: "GET", body: undefined }
      );
     ...
     */
    public async update(
      params: RequestType<typeof api_transaksi_update_update>
    ): Promise<ResponseType<typeof api_transaksi_update_update>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
        akun_id: params["akun_id"],
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_transaksi_update_update
      >;
    }
  }
}
...
export namespace tujuan {
  export class ServiceClient {
     ...
     */
    public async create(
      params: RequestType<typeof api_tujuan_create_create>
    ): Promise<ResponseType<typeof api_tujuan_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/tujuan`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_tujuan_create_create
      >;
    }
     ...
     */
    public async createKontribusi(
      params: RequestType<typeof api_tujuan_kontribusi_createKontribusi>
    ): Promise<ResponseType<typeof api_tujuan_kontribusi_createKontribusi>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/tujuan/kontribusi`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_tujuan_kontribusi_createKontribusi
      >;
    }
    ...
    public async deleteKontribusi(params: { id: string }): Promise<void> {
      await this.baseClient.callTypedAPI(
        `/tujuan/kontribusi/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
    }
    ...
    public async deleteTujuan(params: { id: string }): Promise<void> {
      await this.baseClient.callTypedAPI(
        `/tujuan/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
    }
    ...
    public async get(params: {
      id: string;
    }): Promise<ResponseType<typeof api_tujuan_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/tujuan/${encodeURIComponent(params.id)}`,
        { method: "GET", body: undefined }
     ...
     */
    public async list(
      params: RequestType<typeof api_tujuan_list_list>
    ): Promise<ResponseType<typeof api_tujuan_list_list>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
     ...
     */
    public async listKontribusi(params: {
      tujuan_id: string;
    }): Promise<ResponseType<typeof api_tujuan_kontribusi_listKontribusi>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/tujuan/${encodeURIComponent(params.tujuan_id)}/kontribusi`,
        { method: "GET", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_tujuan_kontribusi_listKontribusi
      >;
    }
     ...
     */
    public async update(
      params: RequestType<typeof api_tujuan_update_update>
    ): Promise<ResponseType<typeof api_tujuan_update_update>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
        catatan: params.catatan,
        jenis_tujuan: params["jenis_tujuan"],
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_tujuan_update_update
      >;
    }
  }
}
...
export namespace dashboard {
  export class ServiceClient {
    ...
    public async getStats(
      params: RequestType<typeof api_dashboard_stats_getStats>
    ): Promise<ResponseType<typeof api_dashboard_stats_getStats>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        tenant_id: params["tenant_id"],
      });
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/dashboard/stats`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_dashboard_stats_getStats
      >;
    }
  }
}
...
export namespace user {
  export class ServiceClient {
    ...
    public async acceptInvite(
      params: RequestType<typeof api_user_accept_invite_acceptInvite>
    ): Promise<ResponseType<typeof api_user_accept_invite_acceptInvite>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/user/accept-invite`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_user_accept_invite_acceptInvite
      >;
    }
    ...
    public async cancelInvite(
      params: RequestType<typeof api_user_cancel_invite_cancelInvite>
    ): Promise<void> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
      ...
      await this.baseClient.callTypedAPI(`/user/invite`, {
        query,
        method: "DELETE",
        body: undefined,
      });
    ...
    public async inviteUser(
      params: RequestType<typeof api_user_invite_inviteUser>
    ): Promise<ResponseType<typeof api_user_invite_inviteUser>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/user/invite`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_user_invite_inviteUser
      >;
    }
    ...
    public async listInvites(
      params: RequestType<typeof api_user_list_invites_listInvites>
    ): Promise<ResponseType<typeof api_user_list_invites_listInvites>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        tenant_id: params["tenant_id"],
      });
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/user/invites`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_user_list_invites_listInvites
      >;
    }
    ...
    public async listMembers(
      params: RequestType<typeof api_user_list_members_listMembers>
    ): Promise<ResponseType<typeof api_user_list_members_listMembers>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        limit: params.limit === undefined ? undefined : String(params.limit),
        offset: params.offset === undefined ? undefined : String(params.offset),
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/user/members`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_user_list_members_listMembers
      >;
    }
    ...
    public async removeMember(
      params: RequestType<typeof api_user_remove_member_removeMember>
    ): Promise<void> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
      ...
      await this.baseClient.callTypedAPI(`/user/member`, {
        query,
        method: "DELETE",
        body: undefined,
      });
    ...
    public async resendInvite(
      params: RequestType<typeof api_user_resend_invite_resendInvite>
    ): Promise<ResponseType<typeof api_user_resend_invite_resendInvite>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/user/invite/resend`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_user_resend_invite_resendInvite
      >;
    }
    ...
    public async updatePermission(
      params: RequestType<typeof api_user_update_permission_updatePermission>
    ): Promise<
      ResponseType<typeof api_user_update_permission_updatePermission>
    > {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/user/permission`, {
        method: "PUT",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_user_update_permission_updatePermission
      >;
    }
  }
}
