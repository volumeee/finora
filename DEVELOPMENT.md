...
```bash
git remote add encore encore://finora-backend-zh3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/finora-backend-zh3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/finora-backend-zh3i/settings/integrations/github)
